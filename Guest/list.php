            ...
            <div class="row row-offcanvas row-offcanvas-right sub-main">
                <div class="col-xs-12 col-sm-7 col-md-9">
                    ...
                    if (!isset($_GET['id'])) {
                        ...
                        $id= $_GET['id'];
                        $sql= "select p.Id,Title,Description,DatePost,ImageUrl,IsHightLight,CateName,FullName from post p inner join categories c on p.CategoryId = c.Id inner join users u on p.UserPostId = u.Id where c.Id=".$id."  ORDER by p.Id DESC limit 200";
                       // echo $sql;
...
?>
                    <div class="row">
                                <ol class="breadcrumb bs-callout bs-callout-info margin-10 padding-10 clearfix title-groups">
                                    ...
                                    <li class="active">
                                        ...
                                        ?>
                                        <a href=""> <?php echo $row1['CateName'] ?></a></li></ol> 
        ...
        <?php
        $pageTitle = $row1['CateName']; // Call this in your pages' files to define the page title 
        //echo $pageTitle;
        ?>
